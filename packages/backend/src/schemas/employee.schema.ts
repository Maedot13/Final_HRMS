...
export const operationalUpdateSchema = z.object({
    ...
    staffType: z.enum(['ACADEMIC', 'REGULAR']).optional(),
    isMarried: z.boolean().optional(),
    academicRank: z.string().optional(),
    sabbaticalEligible: z.boolean().optional(),
    researchLeaveEligible: z.boolean().optional(),
    studyLeaveEligible: z.boolean().optional(),
